...
class Stock(models.Model):
    product = models.OneToOneField(Product, on_delete=models.CASCADE)  # Cada produto pode ter apenas uma entrada de estoque
    quantity = models.PositiveIntegerField()  # Quantidade no estoque
    acquisition_value = models.DecimalField(max_digits=10, decimal_places=2, default=0.00)  # Valor de aquisição, opcional
    date_added = models.DateTimeField(auto_now_add=True)
    responsible_user = models.ForeignKey('Employee', on_delete=models.CASCADE)  # Usuário responsável pela entrada
